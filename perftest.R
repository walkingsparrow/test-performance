                     ...
                     port = 5432, madlib = "madlib", default.schemas = NULL)
{
    ...
    check.interval <- if (time.out > 100) 100 else 10
            ...
            tryCatch({
                ...
                repeat {
                    ...
                    activity <- db.q(
                        ...
                        where application_name = 'PivotalR' and pid =", pid,
    ...
    if(has.extra) res[is.na(time) | identical(time, Inf),extra] <- NA
